...
def predict():
    ...
    if prediction == 1:
        return render_template('result.html',pred=f'The patient is predicted to have Chronic Kidney Disease based on the feature values provided')
    else:
        return render_template('result.html',pred=f'The patient is not predicted to have Chronic Kidney Disease based on the feature values provided')
